...
const DEFAULT_GLOW_COLOR = '22, 197, 94'; // Green color for InvaStop
...
export interface CardData {
  ...
  rankText?: string; // e.g. "#1 most common"
  statLine?: string; // e.g. "found 5,574 times across 6 different areas"
  substats?: string[]; // e.g. ["#1 most common", "Found in 6 locations"]
  size?: 'xl' | 'lg' | 'md';
  imageHeight?: number; // optional explicit image height in px
}
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          const sizeClass = card.size === 'xl' ? 'card--xl' : card.size === 'lg' ? 'card--lg' : 'card--md';
          const cardProps = {
                 ...
                 <div className="card__content" style={{ gap: 10 }}>
                  {card.imageSrc && (
                    <div className="card-image-wrapper" style={{ position: 'relative' }}>
                      ...
                      />
                      {card.label && (
                        <span className="card__label" style={{
                          position: 'absolute',
                          top: 8,
                          left: 8,
                          padding: '2px 8px',
