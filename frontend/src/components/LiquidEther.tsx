...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    console.log('LiquidEther: Initializing WebGL component');

    // @ts-ignore - Complex WebGL implementation
    function makePaletteTexture(stops: string[] | string) {
      let arr;
    ...
    class MouseClass {
      ...
      onDocumentMouseMove(event: MouseEvent) {
        console.log('LiquidEther: Mouse move detected', event.clientX, event.clientY);
...
`;
    ...
    webgl.start();
    console.log('LiquidEther: WebGL manager started successfully');
